...
<body class=" bg-slate-100">
    ...
    <div class=" flex flex-col items-center mx-auto">
        <h1 class=" text-3xl text-center font-bold my-10 underline text-gray-600">Employers</h1>
        <div class="flex w-1/2 justify-center">
            <a href="{{ route('employer.create') }}"
                class="shadow-2xl text-white bg-emerald-400 hover:bg-emerald-600 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2 dark:bg-pink-400 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
                Create an employer entry
            </a>
        </div>
    </div>
