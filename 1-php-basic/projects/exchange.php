...
<section class=" bg-gray-100 p-10 rounded-lg">
    ...
    <section>
        ...
        <form action="" id="exchangeForm"></form>
        <div class="grid grid-cols-2 gap-5">
            <div class=" col-span-full">
                <label for="input-label" class="block text-sm font-medium mb-2 dark:text-white">Currency amount</label>
                <input type="number" id="input-label" name="amount" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600">
            </div>
