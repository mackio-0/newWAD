                ...
                <div class="overflow-hidden">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead>
                            ...
                            <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">Batch Name</th>
                            <th scope="col" class="px-6 py-3 text-end text-xs font-medium text-gray-500 uppercase">Course ID</th>
                            <th scope="col" class="px-6 py-3 text-end text-xs font-medium text-gray-500 uppercase">Start Date</th>
                            <th scope="col" class="px-6 py-3 text-end text-xs font-medium text-gray-500 uppercase">Time</th>
                            <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase">Register</th>
                            <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase">Student Limit</th>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-end font-medium text-gray-800 dark:text-gray-200" title="<?= $row['title'] ?> ">
                                    <?= $row['short'] ?>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-end font-medium text-gray-800 dark:text-gray-200">
                                    <!-- <?= $row['is_register_open'] ? "Open" : "Close" ?> -->
